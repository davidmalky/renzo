  ...
  fetch('https://api.resend.com/emails', {
    ...
    body: JSON.stringify({
      ...
      html: `<div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;padding:32px 24px;color:#1a1a1a">
        ...
        <h2 style="font-weight:600;font-size:20px;margin:0 0 16px">Welcome aboard.</h2>
        <p style="line-height:1.6;color:#444">You're all set to start managing your relationships smarter. Renzo helps you know who to reach out to — and writes the message for you.</p>
        <p style="line-height:1.6;color:#444">To get started:</p>
        <ol style="line-height:2;color:#444">
          <li>Add your contacts or import from a CSV</li>
          <li>Set up your company profile in Settings</li>
          <li>Generate your first outreach message</li>
        </ol>
        ...
        <p style="margin-top:32px;font-size:12px;color:#999">Questions? Reply to this email or visit <a href="https://www.meetrenzo.com/help" style="color:#1F6B47">meetrenzo.com/help</a></p>
      </div>`
    })
